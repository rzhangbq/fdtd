...
\begin{equation}
    \begin{aligned} F_{\mathrm{mid,1}}^n & =\frac{1}{\Delta t}\left[\left(1+\gamma\delta_x^{E,2}\right)S^{n+\frac{1}{2}}-\left(1-\gamma\delta_x^{E,2}\right)S^{n-\frac{1}{2}}\right] \\
                                     ...
                                     & =\frac{2\widehat{S}}{\Delta t}\left[i\sin\left(\frac{\theta}{2}\right)-q\cos\left(\frac{\theta}{2}\right)\right]e^{i(kx+\omega t_n)}.
...
Therefore the magnitude ratios between the quarter-step and midpoint-source terms are
\begin{equation}
