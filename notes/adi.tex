...
\end{equation}
Substituting into \eqref{eq:first-e-ez-adi-tridiagonal-dispersion} and using \eqref{eq:adi-difference-symbols}, the first-half electric update becomes
\begin{equation}
...
\end{equation}
Substituting into \eqref{eq:second-e-ez-adi-tridiagonal-dispersion} and using \eqref{eq:adi-difference-symbols}, the second-half electric update becomes
\begin{equation}
