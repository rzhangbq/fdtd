...
Here we describe the convolutional PML boundary conditions used by the ADI scheme, based on \cite{gedney2001perfectly}.

\subsection{First ADI Half-Step}

The electric auxiliary variables at time level $n$ enter the PML tridiagonal systems. The magnetic auxiliary variables are advanced from the electric fields at the time levels used by the first-half ADI magnetic updates and are then applied directly in the magnetic updates; they do not enter the tridiagonal right-hand sides.
...
\begin{align}
    \begin{split}
        -\alpha_{x1}E_{x,i+\tfrac12,j-1,k}^{n+\frac12} + \beta_{x1}E_{x,i+\tfrac12,j,k}^{n+\frac12} - \gamma_{x1}E_{x,i+\tfrac12,j+1,k}^{n+\frac12}
         ...
         & \quad +\Big(\psi^{n}_{e\,xy,i+\tfrac12,j,k}-\psi^{n}_{e\,xz,i+\tfrac12,j,k}\Big).
    \end{split}
...
\begin{equation}
    \begin{aligned}
        ...
        \Big(E_{y,i+1,j+\tfrac12,k}^{n}-E_{y,i,j+\tfrac12,k}^{n}\Big)                 \\
         & \quad
        +r_{x1}\psi^{n+\frac12}_{h\,zy,i+\tfrac12,j+\tfrac12,k}
        -r_{x1}\psi^{n+\frac12}_{h\,zx,i+\tfrac12,j+\tfrac12,k}.
    \end{aligned}
...
\begin{align}
    \begin{split}
        -\alpha_{y1}E_{y,i,j+\tfrac12,k-1}^{n+\frac12} + \beta_{y1}E_{y,i,j+\tfrac12,k}^{n+\frac12} - \gamma_{y1}E_{y,i,j+\tfrac12,k+1}^{n+\frac12}
         ...
         & \quad +\Big(\psi^{n}_{e\,yz,i,j+\tfrac12,k}-\psi^{n}_{e\,yx,i,j+\tfrac12,k}\Big).
    \end{split}
...
\begin{equation}
    \begin{aligned}
        ...
        \Big(E_{z,i,j+1,k+\tfrac12}^{n}-E_{z,i,j,k+\tfrac12}^{n}\Big)                 \\
         & \quad
        +r_{y1}\psi^{n+\frac12}_{h\,xz,i,j+\tfrac12,k+\tfrac12}
        -r_{y1}\psi^{n+\frac12}_{h\,xy,i,j+\tfrac12,k+\tfrac12}.
    \end{aligned}
...
\begin{align}
    \begin{split}
        -\alpha_{z1}E_{z,i-1,j,k+\tfrac12}^{n+\frac12} + \beta_{z1}E_{z,i,j,k+\tfrac12}^{n+\frac12} - \gamma_{z1}E_{z,i+1,j,k+\tfrac12}^{n+\frac12}
         ...
         & \quad +\Big(\psi^{n}_{e\,zx,i,j,k+\tfrac12}-\psi^{n}_{e\,zy,i,j,k+\tfrac12}\Big).
    \end{split}
...
\begin{equation}
    \begin{aligned}
        ...
        \Big(E_{x,i+\tfrac12,j,k+1}^{n}-E_{x,i+\tfrac12,j,k}^{n}\Big)                 \\
         & \quad
        +r_{z1}\psi^{n+\frac12}_{h\,yx,i+\tfrac12,j,k+\tfrac12}
        -r_{z1}\psi^{n+\frac12}_{h\,yz,i+\tfrac12,j,k+\tfrac12}.
    \end{aligned}
...
After the magnetic fields are updated, the electric auxiliary variables are advanced from the magnetic fields at time level $n$,
...
\begin{subequations}\label{eq:first-pml-aux-coefficients}
    ...
    \end{align}
\end{subequations}
Here $\sigma_s$, $\alpha_s$, and $\kappa_s$ are evaluated at the cell-centered coordinate associated with the same integer index as the corresponding auxiliary variable and in the same derivative direction $s$. A nodal high-wall index with no cell-centered partner uses the interior values $\sigma_s=0$, $\alpha_s=0$, and $\kappa_s=1$. For a PML layer normal to direction $s$, let $\rho_s$ be the distance from the inner PML interface into the PML, $L_s=N_{\mathrm{pml}}\Delta s$ be the PML thickness, and $m$ be the polynomial grading order. Then, for $0\le \rho_s\le L_s$,
\begin{align}
...
Before the magnetic fields are updated, the magnetic auxiliary variables are advanced from the electric fields at the time levels used by the first-half ADI magnetic updates,
...
The electric auxiliary variables at time level $n+\tfrac12$ enter the PML tridiagonal systems. The magnetic auxiliary variables are advanced from the electric fields at the time levels used by the second-half ADI magnetic updates and are then applied directly in the magnetic updates; they do not enter the tridiagonal right-hand sides.
...
\begin{align}
    \begin{split}
        -\alpha_{x2}E_{x,i+\tfrac12,j,k-1}^{n+1} + \beta_{x2}E_{x,i+\tfrac12,j,k}^{n+1} - \gamma_{x2}E_{x,i+\tfrac12,j,k+1}^{n+1}
         ...
         & \quad +\Big(\psi^{n+\frac12}_{e\,xy,i+\tfrac12,j,k}-\psi^{n+\frac12}_{e\,xz,i+\tfrac12,j,k}\Big).
    \end{split}
...
\begin{equation}
    \begin{aligned}
        ...
        \Big(E_{x,i+\tfrac12,j,k+1}^{n+1}-E_{x,i+\tfrac12,j,k}^{n+1}\Big)             \\
         & \quad
        +r_{x2}\psi^{n+1}_{h\,yx,i+\tfrac12,j,k+\tfrac12}
        -r_{x2}\psi^{n+1}_{h\,yz,i+\tfrac12,j,k+\tfrac12}.
    \end{aligned}
...
\begin{align}
    \begin{split}
        -\alpha_{y2}E_{y,i-1,j+\tfrac12,k}^{n+1} + \beta_{y2}E_{y,i,j+\tfrac12,k}^{n+1} - \gamma_{y2}E_{y,i+1,j+\tfrac12,k}^{n+1}
         ...
         & \quad +\Big(\psi^{n+\frac12}_{e\,yz,i,j+\tfrac12,k}-\psi^{n+\frac12}_{e\,yx,i,j+\tfrac12,k}\Big).
    \end{split}
...
\begin{equation}
    \begin{aligned}
        ...
        \Big(E_{y,i+1,j+\tfrac12,k}^{n+1}-E_{y,i,j+\tfrac12,k}^{n+1}\Big)             \\
         & \quad
        +r_{y2}\psi^{n+1}_{h\,zy,i+\tfrac12,j+\tfrac12,k}
        -r_{y2}\psi^{n+1}_{h\,zx,i+\tfrac12,j+\tfrac12,k}.
    \end{aligned}
...
\begin{align}
    \begin{split}
        -\alpha_{z2}E_{z,i,j-1,k+\tfrac12}^{n+1} + \beta_{z2}E_{z,i,j,k+\tfrac12}^{n+1} - \gamma_{z2}E_{z,i,j+1,k+\tfrac12}^{n+1}
         ...
         & \quad +\Big(\psi^{n+\frac12}_{e\,zx,i,j,k+\tfrac12}-\psi^{n+\frac12}_{e\,zy,i,j,k+\tfrac12}\Big).
    \end{split}
...
\begin{equation}
    \begin{aligned}
        ...
        \Big(E_{z,i,j+1,k+\tfrac12}^{n+1}-E_{z,i,j,k+\tfrac12}^{n+1}\Big)             \\
         & \quad
        +r_{z2}\psi^{n+1}_{h\,xz,i,j+\tfrac12,k+\tfrac12}
        -r_{z2}\psi^{n+1}_{h\,xy,i,j+\tfrac12,k+\tfrac12}.
    \end{aligned}
...
After the magnetic fields are updated, the electric auxiliary variables are advanced from the magnetic fields at time level $n+\tfrac12$,
...
Before the magnetic fields are updated, the magnetic auxiliary variables are advanced from the electric fields at the time levels used by the second-half ADI magnetic updates,
