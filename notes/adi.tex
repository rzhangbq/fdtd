...
Figure~\ref{fig:adi-phase-velocity-soft} compares the measured frequencies with the analytic dispersion relation and shows the corresponding time histories and spectra. Both the periodic traveling-wave case and the PEC soft-excitation case show good agreement with the analytical frequency shift. However, the soft-excitation case shows a larger amplitude difference as the CFL number increases.

Indeed, Figure~\ref{fig:adi-amplitude-soft-vs-standing} shows that although the two cases have almost the same frequency behavior, the standing-wave peak amplitude remains nearly constant, whereas the soft-excitation peak decreases significantly as the CFL number increases.

\begin{figure}[htpb]
    \centering
    \includegraphics[width=\linewidth]{png_out/pec_soft_vs_standing_cfl.png}
    \caption{Comparison of the amplitude of the PEC soft-excitation and PEC standing-wave cases with respect to the CFL number.}
    \label{fig:adi-amplitude-soft-vs-standing}
\end{figure}

To determine the origin of this amplitude variation, the response was measured over a range of CFL numbers for several excitation frequencies, as is shown in Figure~\ref{fig:adi-frequency-soft-vs-standing}. Noticeably, the response frequency is independent of the excitation frequency, while the amplitude is not. However, the amplitude does not always decrease with increasing CFL number, it also increases for some excitation frequencies. Generally, when excitation frequency is smaller than the true response frequency, the amplitude increases with increasing CFL number, and when excitation frequency is larger than the true response frequency, the amplitude decreases with increasing CFL number.

\begin{figure}[htpb]
    \centering
    \includegraphics[width=\linewidth]{png_out/pec_soft_drive_freq_vs_cfl.png}
    \caption{Comparison of the frequency of the PEC soft-excitation and PEC standing-wave cases with respect to the CFL number for different excitation frequencies.}
    \label{fig:adi-frequency-soft-vs-standing}
\end{figure}
